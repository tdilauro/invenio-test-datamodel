...
"""Flask extension for Invenio Test Data Model."""
...
class InvenioTestDataModel(object):
    """Invenio Test Data Model extension."""
    ...
    def init_app(self, app):
        ...
        app.extensions['invenio-test-datamodel'] = self
    ...
    def init_config(self, app):
        ...
        for k in dir(config):
            if k.startswith('INVENIO_TEST_DATAMODEL_'):
